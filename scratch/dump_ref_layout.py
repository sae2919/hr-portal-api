...
sys.stdout = open(r"d:\internship\hr-panel\hr-portal-api\scratch\ref_layout_details.txt", "w", encoding="utf-8")
...
sys.stdout.close()
print("Done! Saved details to ref_layout_details.txt")
